...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{EndEffector_Sketch.png}
    \caption{Cross-section of the BrailleSCARA Dual-Mode End-Effector.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{force_graph.png}
    \caption{Theoretical Solenoid Embossing Force vs. 140 GSM Braille Paper Yield Resistance.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{BrailleSCARA_BlockDiagram.png}
