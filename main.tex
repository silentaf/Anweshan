...
\begin{figure}[H]
    \centering
    \includegraphics[height=11cm, keepaspectratio]{BrailleSCARA_Flowchart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{force_verification_diagram.png}
    \caption{Comparison of traditional blind embossing vs. BrailleSCARA's closed-loop force verification}
\end{figure}
...
\vspace{1em}
\noindent\framebox[\textwidth]{\parbox{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}{\centering\vspace{2cm}\textbf{[TODO: INSERT 3D CAD RENDER OF SCARA ARM HERE]}\\Replace this box with an image of your full Fusion 360/SolidWorks CAD render.\vspace{2cm}}}
\vspace{1em}
...
Required angular resolution at J1: arctan(0.05/400) = 0.0072 deg
Encoder CPR needed: 360/0.0072 = 50,000 -> AS5047P (14-bit = 16,384 CPR)
With 4x interpolation: 65,536 counts -> angular resolution = 0.0055 deg
At 400mm reach: positional resolution = 400 * tan(0.0055 deg) = 0.038mm [PASS]
\end{lstlisting}
...
\begin{figure}[H]
    ...
    \caption{Cross-section of the BrailleSCARA Dual-Mode End-Effector detailing the solenoid and force sensor integration.}
\end{figure}
