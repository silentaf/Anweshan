...
\textbf{Vision spot-check (per Braille cell):} After completing a 6-dot cell, MAX78000 camera captures an image. A lightweight CNN (3 conv + 2 FC layers, $<$200K weights, 8-bit quantized) classifies PASS or FAIL.
